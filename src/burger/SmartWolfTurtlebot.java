...
public class SmartWolfTurtlebot extends SmartTurtlebot {
	...
	public SmartWolfTurtlebot(int id, String name, int seed, int field, Message clientMqtt, int debug, int speed) {
